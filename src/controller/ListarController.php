...
class ListarController
{
    ...
    public function disponiveis()
    {
        try{
            ...
            $lista = medico::disponiveis();
            // var_dump($lista);
            // var_dump($parametros);
            
            $loader = new \Twig\Loader\FilesystemLoader('src/view');
            $twig = new \Twig\Environment($loader);
            $template = $twig->load('listardisponiveis.html');
    ...
    public function consultaDisponiveis($params)
    {
        try{
            // var_dump($params);
            $lista_consultas = agendamento::selectByIdMedicoDisponiveis($params);
            // var_dump($lista_consultas);
            $nome = medico::selectNomeById($params);
            
            $loader = new \Twig\Loader\FilesystemLoader('src/view');
            $twig = new \Twig\Environment($loader);
            $template = $twig->load('listar_consultas_disponiveis.html');
